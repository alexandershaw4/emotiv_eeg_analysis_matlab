...
** Edited by Alex Shaw, December 2022 to:
--> not open in full screen
--> only use single-channel, integer markers through the LSL outlet
--> pause after opening the outlet but before commencing the gratings in order to allow user to connect recording
software to the lsl stream. for now this is our 32-channel Emotiv Epoc Flex Saline system recorded using EmotivPRO.
